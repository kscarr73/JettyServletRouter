            ...
            if (objMatch.isSet(FIELD_MATCHES)) {
                ...
                try {
                    ...
                    if (objMatch.isSet(FIELD_RESPONSETYPE)) {
                        if (jettyResp.getApiPayload() != null) {
                            if (CONTENT_TYPE_JSON.equals(objMatch.getString(FIELD_RESPONSETYPE))) {
                                HttpReqHelper.sendJson(resp, jettyResp.getStatus(), jettyResp.getApiPayload());
                            } else if (CONTENT_TYPE_YAML.equals(objMatch.getString(FIELD_RESPONSETYPE))) {
                                HttpReqHelper.sendYaml(resp, jettyResp.getStatus(), jettyResp.getApiPayload());
                            }
                        } else if (jettyResp.getStringPayload() != null) {
                            if (CONTENT_TYPE_JSON.equals(objMatch.getString(FIELD_RESPONSETYPE))) {
                            ...
                            } else if (CONTENT_TYPE_HTML.equals(objMatch.getString(FIELD_RESPONSETYPE))) {
                                HttpReqHelper.sendString(resp, jettyResp.getStatus(), CONTENT_TYPE_HTML, jettyResp.getStringPayload());
                            }
                        } else if (jettyResp.getBytePayload() != null) {
