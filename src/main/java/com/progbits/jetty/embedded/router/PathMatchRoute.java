...
public class PathMatchRoute implements Route {
    ...
    public PathMatchRoute(String method, Pattern path, List<String> pathNames, List<String> pathTypes, Handler handler, String payloadType, String responseType, AuthenticationHandler authHandler) {
        this.method = method;
        this.path = path;
    ...
    public static class PathMatchRouteBuilder {
        ...
        public PathMatchRouteBuilder authHandler(AuthenticationHandler authHandler) {
            this.authHandler = authHandler;
        ...
        public PathMatchRoute build() {
            ...
            return new PathMatchRoute(method, newPath, pathNames, pathTypes, handler, payloadType, responseType, authHandler);
        }
